\documentclass[pdftex,aspectratio=169,xcolor=dvipsnames]{beamer}
...
\usetikzlibrary{decorations.pathmorphing,positioning,shapes.symbols,chains}
...
\newcommand{\CcImageBy}[1]{\includegraphics[scale=#1]{graphics/cc-by-white.pdf}}
\newcommand{\CcImageNc}[1]{\includegraphics[scale=#1]{graphics/cc-nc-white.pdf}}
\newcommand{\CcImageSa}[1]{\includegraphics[scale=#1]{graphics/cc-sa-white.pdf}}
