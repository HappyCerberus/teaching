...
\begin{frame}
	\frametitle{Jednoduchý workflow}
	\begin{itemize}
		\item{vzdálený repozitář, do kterého chceme přispět}
		\item{autorovi chceme na konci poslat patch}
		\item{pro lokální práci využijeme git}
	\end{itemize}
\end{frame}
